...
\chapter{Disentangling Generative Factors}
	...
	% \begin{figure}[htp]
		...
		% \includegraphics[trim={0cm 0cm 0cm 0cm},clip, width=1.0\linewidth]{fig/factor/movekp2}
		% \end{subfigure}
%
		% \begin{subfigure}{0.8\linewidth}
		% \includegraphics[trim={0cm 0cm 0cm 0cm},clip, width=1.0\linewidth]{fig/factor/pose}
		% \end{subfigure}
		% \begin{subfigure}{0.8\linewidth}
