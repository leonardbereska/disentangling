...
\section{Disentangling Representations}\label{sec:disentangled}
	...
	\begin{quote}
		{Disentangle as many factors as possible, discarding as little information about the data as is practical.} - \cite{Bengio2013rep} % Y. Bengio, A. Courville and P. Vincent \cite{Bengio2013rep}
	\end{quote}
