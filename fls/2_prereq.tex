...
\section{Learning from Data}
	...
	\subsection{Unsupervised}\label{sec:unsupervised}
		...
		\begin{itemize}
			\item Naturally, without supervision, \textit{the goal of learning is not specified}, hence surrogate objectives have to be formulated. The lack of specification renders the evaluation often arbitrary and subjective\todo{cite evaluation of generative models}.
