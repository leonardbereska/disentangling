...
\section{Learning from Data}
	...
	\subsection{Unsupervised}\label{sec:unsupervised}
		...
		\begin{itemize}
			...
			\item It is a priori not clear, how much prior knowledge should be embedded. To introduce no artificial bias, some argue for a purely data-driven approach. Others argue for the importance of certain inductive priors to guide learning \cite{tenenbaum18think}.
